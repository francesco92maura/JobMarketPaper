/*
This .do file is divided as follow:
- from line 11 to line 70 generates the health index of the paper
- from line 73 to line 660 performs the main data analysis and estimates of the paper
- from line 660 to the end performs the appendix estimates and robustness checks
*/
clear
* Laptop - lenovo
...
/***************************************************************/
* Health index - from Dal Bianco (2020) *
/***************************************************************/
...
/*
switch to R file "01_datapreparation.R" for data management
*/

clear

*use "wave_8_FM_v2.dta"
use "wave_8_empirical_analysis.dta", clear
